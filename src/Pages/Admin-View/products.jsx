...
export default function Adminproducts() {
  ...
  const [product, setProduct] = useState({
    ...
    images: [],
    view360: "",
    variants: [{ size: "", weight: "250g", stock: 0, price: 0, salesPrice: 0 }],
    customBoxPrices: [
      { size: "Small", pricePerPiece: 0 },
      { size: "Medium", pricePerPiece: 0 },
      { size: "Large", pricePerPiece: 0 },
    ...
    <Fragment>
      <div className="mb-6">
        <Button
          ...
          className="bg-[#F08C7D] text-white flex gap-2"
        >
            ...
            <DialogDescription>
              <form onSubmit={handleProductSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  {product.variants.map((variant, index) => (
                    <div key={index} className="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-3">
