...
import { MessageCircle, X, Send, MessageSquare, ChevronDown } from "lucide-material";
      ...
      {open && (
        <div 
          className={`
            ...
            /* Mobile: Start exactly below your Red Announcement Bar */
            inset-x-0 bottom-0 top-[115px] 
            /* Desktop: Floating in the corner, not touching the top */
        ...
        >
          ...
          {/* Header: Cleaned up mt-8 to fix the text cut-off */}
          ...
          <div className="p-4 md:p-5 bg-white border-t border-stone-100 pb-[env(safe-area-inset-bottom,16px)]">
            <div className="relative flex items-center bg-stone-50 rounded-2xl px-4 py-1.5 border border-stone-200/60 focus-within:bg-white focus-within:border-stone-900/20 transition-all duration-300">
              ...
              <button
                onClick={handleSend}
                disabled={!input.trim()}
                className="p-2 text-[#B23A2E] hover:scale-110 disabled:opacity-20 transition-all"
              >
