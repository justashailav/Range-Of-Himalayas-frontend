...
import { Search } from "lucide-react"; // Ensure you have lucide-react or similar for icons
...
export default function Login() {
  ...
  // FIXED: Local state to track if the user actually clicked the button
  // This prevents Chrome's autofill from triggering the "Verifying" text
  ...
  // Clear any old auth errors when the component first loads
  useEffect(() => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    setIsSubmitting(true); // User has now manually clicked
  ...
  return (
    <div className="min-h-screen overflow-hidden">
      <Helmet>
        ...
        <meta name="description" content="Access your Himalayan harvest records." />
      </Helmet>
      ...
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-[#fdfcf7] p-8 md:p-12 relative">
          ...
          <div className="absolute top-0 right-0 p-10 opacity-[0.03] pointer-events-none select-none hidden lg:block">
              ...
              <div className="pt-6 space-y-6">
                ...
                >
                  ...
                  <span className="relative z-10 text-[10px] font-black uppercase tracking-[0.5em]">
                    {/* Only show Verifying if user manually clicked AND redux is loading */}
                    {isSubmitting && loading ? "Verifying..." : "Authenticate"}
                  </span>
                </button>
