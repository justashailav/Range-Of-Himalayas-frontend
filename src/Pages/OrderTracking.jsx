          ...
          >
                    ...
                    <div className="flex flex-col md:flex-row gap-6 md:gap-12">
                      ...
                      <div className="relative">
                        ...
                        <p className="text-sm md:text-base font-black text-stone-800 uppercase tracking-tighter">
                          Starting 18 April{" "}
                          <span className="text-stone-300 font-serif italic lowercase font-light tracking-normal">
                            2026
                          </span>
                        </p>
            ...
            >
              <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3">
                {order.orderStatus === "delivered" ? (
                  <>
                    <span className="text-[#B23A2E] text-base md:text-lg">
                      ✓
                    </span>
                    <span className="leading-relaxed">
                      Consignment{" "}
                      <span className="hidden md:inline">Successfully</span>{" "}
                      Delivered
                    </span>
                  </>
                ) : (
                  <>
                    ...
                    <span className="leading-relaxed">
                      Transit in Progress{" "}
                      <span className="md:mx-2 text-stone-300 hidden md:inline">
                        —
                      </span>
