...
import { CheckCircle, Package, Truck, Home, Clock, Search, Fingerprint } from "lucide-react";
...
export default function OrderTracking() {
  ...
  >
    {loading ? (
      ...
      <>
        <span className="text-[10px] font-black uppercase tracking-[0.3em]">Locate</span>
