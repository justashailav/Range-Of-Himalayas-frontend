    ...
    <div className="bg-[#F9F5EF] min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 text-center space-y-8">
          ...
          >
            Our private orchards are nearing peak ripeness. Join the curated
            waitlist for
            <span className="text-white mx-1 font-bold">priority access</span>
            to the season's first pick, exclusive member pricing, and direct
            updates from the foothills.
          </motion.p>

          <motion.div variants={fadeIn} custom={0.3} className="pt-4">
            <motion.a
            ...
            >
              ...
              >
                ...
                <ArrowRight
                  size={16}
                  className="group-hover:translate-x-2 transition-transform duration-300 text-[#B23A2E]"
                />
              </motion.button>
            </motion.a>
          </motion.div>
