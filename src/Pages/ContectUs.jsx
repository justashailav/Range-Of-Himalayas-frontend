      ...
      >
        ...
        >
          ...
          <p className="text-stone-500 font-serif italic text-lg max-w-2xl mx-auto leading-relaxed">
            Whether you seek guidance on our seasonal harvests or wish to share
            your experience, our Himalayan team is attentive to every word.
          </p>
        </motion.header>
        ...
        >
          ...
          <div className="mt-4">
            {message && (
              <p className="text-green-600 text-[11px] font-black uppercase tracking-widest text-center animate-pulse">
                {message}
              </p>
            )}
            {error && (
              <p className="text-[#B23A2E] text-[11px] font-black uppercase tracking-widest text-center">
                {error}
              </p>
            )}
          </div>
