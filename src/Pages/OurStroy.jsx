...
export default function OurStory() {
  ...
  <div className="max-w-7xl mx-auto">
    ...
    >
      <span className="text-[#B23A2E] font-black uppercase tracking-[0.3em] text-xs">The Process</span>
      <h2 className="text-4xl md:text-6xl font-black text-stone-900 mt-4 tracking-tighter">
        A Journey of <span className="italic font-serif font-light text-stone-500">Patience.</span>
      </h2>
    </motion.div>
          ...
          {[
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-[#B23A2E] font-black text-sm tracking-widest mb-2">STEP {item.num}</span>
      ...
      >
        <div className="relative p-4 bg-stone-50 border border-stone-200 rounded-2xl shadow-2xl">
          ...
          <div className="absolute -bottom-6 -right-6 bg-stone-900 text-white p-6 rounded-xl hidden md:block shadow-2xl">
            <p className="text-xs uppercase tracking-[0.3em] font-bold text-stone-400">Location</p>
            <p className="text-lg font-serif italic mt-1">Himachal Pradesh, India</p>
          </div>
        </div>
  ...
  <div className="max-w-7xl mx-auto relative z-10">
    ...
    >
      <h2 className="text-4xl md:text-6xl font-black text-stone-900 tracking-tighter mb-6">
        The <span className="italic font-serif font-light text-stone-500 underline decoration-red-200 underline-offset-8">Difference</span> is Altitude.
      </h2>
  ...
  <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center relative z-10">
    ...
    <div>
      ...
      >
        ...
        <p className="mt-8 text-xl text-stone-500 font-light leading-relaxed max-w-xl">
          At <span className="text-stone-900 font-semibold italic">2,300m elevation</span>, nature moves at its own pace. 
          Fruits ripen slowly in the thin mountain air, concentrating sugars and nutrients to create an 
          <span className="text-stone-900 font-medium"> unmatched intensity of flavor.</span>
        </p>
      </motion.div>
      ...
      <div className="mt-16 grid sm:grid-cols-2 gap-4">
        {[
          ...
          >
            ...
            <h3 className="font-bold text-stone-900 text-sm uppercase tracking-tight">{item.title}</h3>
    ...
    <div className="relative">
      ...
      >
        ...
        >
          <p className="text-[10px] uppercase tracking-[0.4em] text-stone-400 mb-1">Current Altitude</p>
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-black">2,300</span>
            <span className="text-lg font-serif italic text-stone-400">meters</span>
          </div>
        </motion.div>
      </motion.div>
