        ...
        <div className="flex flex-col md:flex-row gap-8 items-start relative z-10">
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-white uppercase tracking-tighter">
              Our Himalayan{" "}
              <span className="font-serif italic capitalize tracking-normal text-stone-400">
                Promise
              </span>
            </h2>
            ...
            <p className="text-stone-400 text-base md:text-lg leading-relaxed font-serif italic max-w-3xl">
              ...
              taste of nature’s{" "}
              <span className="text-white not-italic font-sans font-black uppercase text-[10px] tracking-widest ml-1">
                Purity Verified
              </span>
              ."
            </p>
        ...
        <section>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <p className="text-stone-400 text-sm font-serif italic max-w-sm">
              "Once payment is verified, our estate team initiates the
              cold-chain preparation protocol to preserve peak botanical
              integrity."
            </p>
          </div>
            ...
            {steps.map(({ icon: Icon, title, desc }, index) => (
              ...
              >
                <div className="flex justify-between items-start mb-8">
                  <Icon
                    strokeWidth={1}
                    className="h-8 w-8 text-stone-500 group-hover:text-[#F08C7D] transition-colors"
                  />
                  <span className="text-[10px] font-black text-white/10 group-hover:text-[#F08C7D]/20">
                    0{index + 1}
                  </span>
                </div>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
              {deliveryNotes.map((note, i) => (
                <li key={i} className="flex items-start gap-4">
                  <span className="text-[10px] font-serif italic text-stone-600 mt-1">
                    /0{i + 1}
                  </span>
      ...
      <div className="bg-[#111111] border border-white/5 p-8 md:p-12 mb-10 relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <p className="text-stone-400 text-sm md:text-base font-serif italic mb-10 max-w-2xl leading-relaxed">
            "Monitor your harvest's journey from our Kotkhai estate to your
            residence. Utilize the unique digital signature provided in your
          ...
          <div className="border-t border-white/5 pt-8 flex items-start gap-4 group/note">
            <div className="p-2 bg-white/5 rounded-full group-hover/note:bg-[#F08C7D]/10 transition-colors duration-500">
              <Clock
                className="h-5 w-5 text-[#F08C7D] opacity-60"
                strokeWidth={1.5}
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-stone-500 text-[11px] md:text-xs leading-relaxed uppercase tracking-wider max-w-xl">
                Standard transits are strictly adhered to; however, atmospheric
                or logistics fluctuations in the Himalayan region may
                necessitate marginal adjustments.
              </p>
            </div>
          </div>
        </div>
        ...
        <section>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <Truck
                  className="h-5 w-5 text-[#F08C7D] opacity-80"
                  strokeWidth={1}
                />
                <span className="text-[10px] font-black uppercase tracking-[0.6em] text-[#F08C7D]">
                  Shipping Policy
            ...
            <p className="text-stone-400 text-sm font-serif italic max-w-sm leading-relaxed">
              "We facilitate nationwide distribution across the Indian
              subcontinent. Transit durations are influenced by regional
              atmospheric conditions and high-altitude logistics."
            </p>
          </div>
            ...
            {[
              {
                title: "Metro Hubs",
                time: "2–4 Days",
                desc: "Delhi, Mumbai, Bangalore, Chennai, Kolkata, Hyderabad, Pune",
              },
              {
                title: "Tier II Regions",
                time: "3–6 Days",
                desc: "State capitals and primary urban sectors",
              },
              {
                title: "Remote Frontiers",
                time: "5–10 Days",
                desc: "Rural territories and high-altitude locations",
              },
            ].map((zone, i) => (
              <div
                key={i}
                className="p-8 group hover:bg-white/[0.02] transition-colors duration-500"
              >
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-stone-400 text-base md:text-lg font-serif italic max-w-xl">
                "As part of our commitment to the discerning collector, all
                archival harvests are delivered with zero transit fees. Pure
                botanical value, delivered without compromise."
              </p>
            </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <span className="text-[#F08C7D] font-black text-xs uppercase tracking-widest">
                      Gratis
                    </span>
                  </div>
