...
export default function ProductsDetailsDialog() {
  ...
  const handleAddToWishList = (productId, stock, size, weight) => {
    if (!user?._id) {
      toast.error(
    ...
    if (existingItem && existingItem.quantity + 1 > stock) {
      toast.error(`Only ${stock} quantity available for this variant`);
      return;
    }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            {productDetails?.nutrition && (
              <div className="bg-[#FFF8E1] rounded-xl p-6 mt-4 border shadow-sm">
                <h3 className="font-bold mb-4 text-xl pb-2">Nutrition</h3>
                <div className="space-y-3">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              ...
              <Button
                ...
                className="flex-1 bg-white border-2 border-[#F08C7D] text-[#F08C7D] py-4 font-semibold rounded-md flex items-center justify-center gap-2 hover:bg-[#F08C7D] hover:text-white transition"
              >
                <Heart /> Wishlist
              </Button>
            </div>
