  ...
  <div className="p-7 pt-2 flex flex-col gap-5">
    <div className="space-y-1">
        <div className="flex items-center gap-2">
            ...
            <p className="text-[9px] uppercase tracking-[0.3em] text-[#D84C3C] font-black">Himalayan Origin</p>
        </div>
      ...
      <div className="flex gap-3">
        {hasSizes && (
          <div className="flex-1">
            <label className="text-[8px] uppercase tracking-widest font-bold text-gray-400 mb-1.5 block">Size</label>
        ...
        <div className="flex-1">
          <label className="text-[8px] uppercase tracking-widest font-bold text-gray-400 mb-1.5 block">Weight</label>
          <div className="relative">
            <select
    ...
    <div className="pt-1">
      {stock === 0 ? (
        ...
        >
          ...
          <span className="opacity-30 group-hover:translate-x-1 group-hover:opacity-100 transition-all duration-500">→</span>
        </button>
      )}
    </div>
  </div>
