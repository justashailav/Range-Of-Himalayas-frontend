          ...
          <div className="relative z-10 flex flex-col items-center max-w-xs">
            ...
            <div className="text-center space-y-6 mb-12">
              ...
              <p className="text-[#fdfcf7]/40 font-serif italic text-sm leading-relaxed px-4">
                "Already a part of the harvest? Re-authenticate to access your
                private ledger."
              </p>
            </div>
          ...
          <div className="max-w-sm w-full relative z-10">
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              <div className="relative group">
                <label className="text-[9px] font-black uppercase tracking-widest text-[#4a5a4a]/60 mb-1 block">
                  Full Name
                </label>
                <input
                  type="text"
              ...
              <div className="block md:hidden text-center pt-4">
                <p className="text-[10px] font-black uppercase tracking-widest text-[#4a5a4a]/60">
                  Already a member?{" "}
                  <Link to="/login" className="text-[#B23A2E] underline">
                    Sign In
                  </Link>
                </p>
              </div>
