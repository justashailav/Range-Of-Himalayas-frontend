...
//   return (
//     <nav className="fixed top-0 left-0 w-full z-50 bg-[#F08C7D]/95 backdrop-blur-md min-h-16 md:h-20 px-4 sm:px-6 lg:px-10 shadow-md">
    ...
    >
        ...
        <div className="flex items-center justify-between w-full lg:hidden">
          ...
          <div className="flex items-center gap-4 mt-2">
            ...
            <Link to="/wishlist" className="relative">
              <Heart className="text-white text-2xl cursor-pointer" />
              {wishListCount > 0 && (
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => setSearchTerm(e.target.value)}
                onKeyDown={handleKeyDown}
                className="pl-2 pr-8 py-1 rounded bg-white/20 text-white placeholder-white"
              />
            </div>
      ...
      {isMenu && (
        <motion.div
          ...
          className="fixed top-0 right-0 h-full w-72 bg-[#F08C7D] p-6 flex flex-col gap-5 text-white z-50"
        >
          <FaTimes
