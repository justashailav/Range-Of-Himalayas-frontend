...
>
  ...
  <div
    className="
      ...
      px-4 py-4 space-y-6 sm:space-y-5
      pb-[260px] sm:pb-[200px]
    "
  >
    {/* CART ITEMS */}
    {(cartItems || []).length > 0 ? (
  ...
  {/* ================= STICKY FOOTER ================= */}
  <div className="sticky bottom-0 z-30 bg-white border-t px-4 py-5 space-y-4">
    {/* COUPON */}
    ...
    <Link
      ...
      className={`block text-center w-full py-4
